...
This Guide is a companion to the CDEI’s AI assurance Roadmap [link] which sets out the key steps required to build an effective and mature assurance ecosystem. The AI assurance roadmap aims to make a significant, early contribution to shaping and bringing coherence to this ecosystem. It sets out the roles that different groups will need to play, and the steps they will need to take, to move to a more mature ecosystem.
