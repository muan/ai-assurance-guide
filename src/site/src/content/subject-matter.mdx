...
1. Whether a subject matter can be observed directly
...
Similar processes are in place for organisational risk management. For example, the overarching goal of the ISO risk management standard is to develop a risk management culture where employees and stakeholders are aware of the importance of monitoring and managing risk.​ This risk management culture and awareness needs to be evaluated against the criteria to demonstrate trustworthy risk management.
...
Taking account of the subjectivity of what is fair in different cases and contexts, we need to be realistic about what level of technical standardisation is achievable. It is very unlikely that we’re going to get to a universal performance standard for algorithmic bias that is applicable everywhere.
