...
<OutboundLink href="https://www.bsigroup.com/en-GB/standards/Information-about-standards/what-is-a-standard/#:~:text=In%20essence%2C%20a%20standard%20is,and%20used%20by%20their%20customers.">
  Technical standards
</OutboundLink> are essentially agreed ways of doing things - making a product, managing
a process, delivering a service or supplying materials. The point of a standard is
to provide a reliable, shared basis for people to share the same expectations about
a product, process system or service.
